            ...
            <main class="col-md-9 card p-3" style="border-radius: 0; height: 100vw;">
                ...
                <div class="card card-discussions p-3">
                    <div class="row">
                        ...
                        {{-- column 2 --}}
                        <div class="col-12 col-lg-10 mb-1 mb-lg-0 d-flex flex-row flex-lg-column flex-wrap">
                            <a href="#" class="text-nowrap me-2 me-lg-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 col-lg-4">
                                    ...
                                    <span class="fs-12px">
                                        ...
                                        <span class="text-light">6 Jam yang lalu</span>
                                    </span>
                                </div>
                            </div>
                        </div>
